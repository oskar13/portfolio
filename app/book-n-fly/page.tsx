    ...
    <>
      <main>
        ...
        <section className="max-w-screen-lg px-4 my-8 mx-auto">
          ...
          <a href="./img/booknfly/1_full.png" target="_blank" rel="noopener noreferrer">
            <Image
              src={"./img/booknfly/1_full.png"}
              width={200}
              height={100}
              className="w-full"
          ...
          <h3 className=" text-2xl mb-4">Flight Page</h3>
          <a href="./img/booknfly/2_full.png" target="_blank" rel="noopener noreferrer">
            <Image
              src={"./img/booknfly/2_full.png"}
              width={200}
              height={100}
              className="w-full"
              alt="Flight page"
